from configs.ToURBAN import SOURCE_DATA_CONFIG,TARGET_DATA_CONFIG, EVAL_DATA_CONFIG, TEST_DATA_CONFIG, TEST_DATA_CONFIG_SOURCE, TARGET_SET
MODEL = 'ResNet'
...
NUM_STEPS = 15000
NUM_STEPS_STOP = 11000  # Use damping instead of early stopping
